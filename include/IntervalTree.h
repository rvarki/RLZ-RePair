...
public:
    ...
    // *Rahul: I made slight modification by switching the equalities around so that
    // findContained gives the phrases that contain the interval instead of the 
    // phrases contained within the interval.
    template <class UnaryFunction>
